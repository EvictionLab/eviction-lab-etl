...
years = 00 10
geo_types = tracts # states counties cities block-groups
...
clean:
	...
	rm -f log/*.txt
# commented out by Joe Fish, if needed email jf42@princeton.edu and add back in. 
...
data/demographics/years/tracts-00.csv: data/demographics/raw/tracts-00.csv census/00/tracts-weights.csv
	...
	python3 scripts/convert_00_geo.py tracts census/00/tracts-weights.csv /Users/joefish/Desktop/count_rate_cols.csv /Users/joefish/Desktop/hh_pop_housing.csv | \
...
data/demographics/years/block-groups-00.csv: data/demographics/raw/block-groups-00.csv census/00/block-groups-weights.csv
	...
	python3 scripts/convert_00_geo.py block-groups census/00/block-groups-weights.csv /Users/joefish/Desktop/count_rate_cols.csv  /Users/joefish/Desktop/hh_pop_housing.csv | \
	python3 scripts/convert_census_vars.py > $@

### WEIGHTS
# These have been commented out because the script uses Ashley's weights as a given argument. 
